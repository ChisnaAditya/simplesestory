...
export default function About() {
    return (
        <>
            <Navbar textColor="text-brand-primary" />
            <div className="container flex flex-col items-center pt-10 pb-10">
                <h1 className="text-brand-primary mb-3 mt-2 text-center text-2xl font-semibold tracking-tight lg:text-2xl lg:leading-snug">
                    About
                </h1>
